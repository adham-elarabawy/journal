...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "When the user asks to reflect on or unpack an entry, help them understand their feelings "
        "and thoughts, then title the chat 'MMM D, YYYY — Short specific description' using the "
        "entry's recording date and central theme, not today's date. If chat renaming is unavailable, "
        "show the exact title as a suggestion; never claim the chat was renamed. For example, "
        "'Jan 5, 2026 — Learning to Trust Myself'. "
        ...
        "When the user asks to understand, structure, or get an opinion about an entry, treat it "
        "as a spoken journal entry with the same reflection and title behavior. Both are opt-in: "
